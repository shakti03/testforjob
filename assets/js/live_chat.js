        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if (data) {
                    ...
                    $('#div_chat_'+ data['fid']).append("<div style='overflow-y:auto; height:180px;' id=\"chat_" + data['fid'] + "\"></div><br>");
                    ...
                    if (data) {
                        ...
                        if (((keys[0].split('_'))[0]) == 'activechat') {
                            ...
                            $.each(data, function(k, v){
                                ...
                                $('#div_chat_'+(k.split('_')[1])).append("<div style='overflow-y:auto; height:180px;' id='chat_"+ (k.split('_')[1]) +"'></div>");
                            ...
                            //console.log(data);
                            $.each(data, function(k,v){
                                if ( $('.live-chat-window').children().children().length == 1 ) {
                                    $('.live-chat-window').children('div:first').remove();
                                    var rev_data = {}
                                    rev_data['fid'] = v['fid']
                                    ...
                                    $('#div_chat_'+ v['fid']).append("<div style='overflow-y:auto; height:180px;' id='chat_"+ v['fid'] +"'></div>");
