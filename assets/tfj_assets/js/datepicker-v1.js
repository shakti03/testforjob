...
(function(c, j) {
    ...
    if (!c.ui.version) {
        ...
        c.fn.extend({_focus: c.fn.focus, focus: function(a, b) {
                ...
                var a;
                a = /(static|relative)/.test(this.css("position")) || /absolute/.test(this.css("position")) ? this.parents().filter(function() {
...
(function(d, B) {
    function M() {
        ...
        this._defaults = {showOn: "focus", showAnim: "fadeIn", showOptions: {}, defaultDate: null, appendText: "", buttonText: "...", buttonImage: "", buttonImageOnly: false, hideIfNoPrevNext: false, navigationAsDateFormat: false, gotoCurrent: false, changeMonth: true, changeYear: true, yearRange: "c-5:c+5", showOtherMonths: false, selectOtherMonths: true, showWeek: false, calculateWeek: this.iso8601Week, shortYearCutoff: "+10",
    ...
    d.extend(M.prototype, {markerClassName: "hasDatepicker", log: function() {
        ...
        _checkExternalClick: function(a) {
            ...
            n = this._canAdjustMonth(a, -1, m, g) ? '<a><span>' + n + "</span></a>" : f ? "" : '<a class="ui-datepicker-prev ui-corner-all ui-state-disabled" title="' + n + '"><span>' + n + "</span></a>";
            var r = this._get(a, "nextText");
            r = !h ? r : this.formatDate(r, this._daylightSavingAdjust(new Date(m,
                    g + j, 1)), this._getFormatConfig(a));
            f = this._canAdjustMonth(a, +1, m, g) ? '<a><span>' + r + "</span></a>" : f ? "" : '<a class="ui-datepicker-next ui-corner-all ui-state-disabled" title="' + r + '"><span>' + r + "</span></a>";
            ...
            w += e + (!a.inline ? '<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>' :
                    "");
            a._keyEvent = false;
            return w
