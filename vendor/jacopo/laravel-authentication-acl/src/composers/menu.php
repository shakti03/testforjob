 ...
 */
View::composer(['laravel-authentication-acl::admin.layouts.*','admin.*'], function ($view)
{
 ...
 * Dashboard sidebar
 */
View::composer(['laravel-authentication-acl::admin.dashboard.*', 'admin.*'], function ($view)
{
 ...
 *  Group sidebar
 */
View::composer(['laravel-authentication-acl::admin.group.*', 'admin.*'], function ($view)
{
    $view->with('sidebar_items', [
            "Groups list" => [
 ...
 *  Permission sidebar
 */
View::composer(['laravel-authentication-acl::admin.permission.*','admin.*'], function ($view)
{
    $view->with('sidebar_items', [
            "Permissions list" => [
 ...
 *  Questions sidebar
 */
View::composer(['admin.question.*','admin.*'], function ($view)
{
    $view->with('sidebar_items', [
            "Question list" => [
                    'url'  => URL::to('questions'),
                    "icon" => '<i class="fa fa-lock"></i>'
            ]
    ]);
});
