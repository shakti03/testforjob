    ...
    <body>
        ...
        <div class="feature">
            <div class="container">
                ...
                <div class="col-md-12">
                    <div class="col-md-3">
                        <img class="img-responsive" src="assets/images/feature_1.jpg"/>
                    </div>
                    <div class="col-md-3">
                        <img class="img-responsive" src="assets/images/feature_2.jpg"/>
                    </div>
                    <div class="col-md-3">
                        <img class="img-responsive" src="assets/images/feature_3.jpg"/>
                    </div>
                    <div class="col-md-3">
                        <img class="img-responsive" src="assets/images/feature_4.jpg"/>
                    </div>
                    <div class="col-md-3">
                        <img class="img-responsive" src="assets/images/feature_5.jpg"/>
                    </div>
                    <div class="col-md-3">
                        <img class="img-responsive" src="assets/images/feature_6.jpg"/>
                    </div>
                    <div class="col-md-3">
                        <img class="img-responsive" src="assets/images/feature_7.jpg"/>
                    </div>
                    <div class="col-md-3">
                        <img class="img-responsive" src="assets/images/feature_8.jpg"/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="feature">
            <div class="container">
                <div class="col-md-12">
                    ...
                    <a class="col-md-3"><img style="margin-top: 15%;" src="assets/images/know_more.jpg"/></a>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <img width="50px" height="50px" class="img-circle" src="assets/images/icon_feature_1.jpg"/>
                    ...
                    <div class="col-md-4">
                        <img width="50px" height="50px" class="img-circle" src="assets/images/icon_feature_2.jpg"/>
                        <h4>High Quality Content</h4>
                        <p class="lead">Videos, TopiceWise, Sectional & MockVideos, TopiceWise, Sectional & MockVideos, TopiceWise, Sectional & MockVideos, TopiceWise, Sectional & Mock</p>
                    </div>
                    <div class="col-md-4">
                        <img width="50px" height="50px" class="img-circle" src="assets/images/icon_feature_3.jpg"/>
                        <h4>High Quality Content</h4>
                        <p class="lead">Videos, TopiceWise, Sectional & MockVideos, TopiceWise, Sectional & MockVideos, TopiceWise, Sectional & MockVideos, TopiceWise, Sectional & Mock</p>
                    </div>
                    <div class="col-md-4">
                        <img width="50px" height="50px" class="img-circle" src="assets/images/icon_feature_4.jpg"/>
                        <h4>High Quality Content</h4>
                        <p class="lead">Videos, TopiceWise, Sectional & MockVideos, TopiceWise, Sectional & MockVideos, TopiceWise, Sectional & MockVideos, TopiceWise, Sectional & Mock</p>
                    </div>
                    <div class="col-md-4">
                        <img width="50px" height="50px" class="img-circle" src="assets/images/icon_feature_5.jpg"/>
                        <h4>High Quality Content</h4>
                        <p class="lead">Videos, TopiceWise, Sectional & MockVideos, TopiceWise, Sectional & MockVideos, TopiceWise, Sectional & MockVideos, TopiceWise, Sectional & Mock</p>
                    </div>
                    <div class="col-md-4">
                        <img width="50px" height="50px" class="img-circle" src="assets/images/icon_feature_6.jpg"/>
                        <h4>High Quality Content</h4>
                        <p class="lead">Videos, TopiceWise, Sectional & MockVideos, TopiceWise, Sectional & MockVideos, TopiceWise, Sectional & MockVideos, TopiceWise, Sectional & Mock</p>
                    </div>
                    <div class="col-md-4">
                        <img width="50px" height="50px" class="img-circle" src="assets/images/icon_feature_7.jpg"/>
                        <h4>High Quality Content</h4>
                        <p class="lead">Videos, TopiceWise, Sectional & MockVideos, TopiceWise, Sectional & MockVideos, TopiceWise, Sectional & MockVideos, TopiceWise, Sectional & Mock</p>
                    </div>
                    <div class="col-md-4">
                        <img width="50px" height="50px" class="img-circle" src="assets/images/icon_feature_8.jpg"/>
                        <h4>High Quality Content</h4>
                        <p class="lead">Videos, TopiceWise, Sectional & MockVideos, TopiceWise, Sectional & MockVideos, TopiceWise, Sectional & MockVideos, TopiceWise, Sectional & Mock</p>
                    </div>
                    <div class="col-md-4">
                        <img width="50px" height="50px" class="img-circle" src="assets/images/icon_feature_9.jpg"/>
                        <h4>High Quality Content</h4>
                        <p class="lead">Videos, TopiceWise, Sectional & MockVideos, TopiceWise, Sectional & MockVideos, TopiceWise, Sectional & MockVideos, TopiceWise, Sectional & Mock</p>
                    </div>
                </div>
        ...
        <div class="footer">
            ...
            <div class="row">
                ...
                <div class="col-md-2"><a class="live-chat-btn" href="#"><img width="40px;" src="assets/images/icon_chat.png"/>Live chat</a></div>                
            </div>
            <div class="row">
                ...
                <div class="col-md-3 col-md-offset-9 live-chat">
                    <div>Live Chat<a><img class="img-circle float close-initial-chat" width="25px;" src="assets/images/icon_close.png"/></a></div>
