<div class="footer">
	...
	<!--<div class="row">
		<div class="col-md-6">
			...
			<div class="panel panel-success live-chat">
	            <div class="panel-heading">
	            	<button aria-label="Close" data-dismiss="panel" class="close close-initial-chat" type="button"><span aria-hidden="true">×</span></button>

	                <h3 class="panel-title bariol-thin"><img width="20px;" src="{{URL::to('/')}}/assets/images/icon_chat.png"/> &nbsp;Live chat</h3>
	            </div>
